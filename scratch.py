...
@click.option('--batch-size', default=2, help="Size of batch per iteration", type=int)
@click.option('--min-graph-size', default=5, help="THe smallest size of training graph", type=int)
@click.option('--max-graph-size', default=5, help="THe smallest size of training graph", type=int)
...
def train(max_epoch, batch_size, min_graph_size, max_graph_size, num_neurons, critic_num_neurons,
    ...
    agent = Agent(num_static_features=2,
